...
func TestProcessCAPIRole(t *testing.T) {
	...
	watcher := &CAPIRbacWatcher{clusters: []*models.Cluster{testCluster}}
...
func TestApplyToClusters(t *testing.T) {
	...
	counter := 0
	applyToClusters([]string{"cluster1"}, testClusters, func(c *models.Cluster) {
		counter++
	})
...
func TestApplyToClusters_NonExistentCluster(t *testing.T) {
	...
	counter := 0
	applyToClusters([]string{"cluster3"}, testClusters, func(c *models.Cluster) {
		counter++
	})
